    ...
    <>
      ...
      <DashboardBox gridArea='j'>
        ...
        <Typography variant='h6' margin='0 1rem'>
          Chart refers to the collection, processing, and analysis of
          information to gain insights and make informed decisions. It can take
          many forms, such as numerical, textual, or visual, and can be sourced
